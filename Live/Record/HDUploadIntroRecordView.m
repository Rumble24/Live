...
- (void)captureOutput:(AVCaptureOutput *)captureOutput didOutputSampleBuffer:(CMSampleBufferRef)sampleBuffer fromConnection:(AVCaptureConnection *)connection {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(uploadIntroRecordViewDidOutputSampleBuffer:isVideo:)]) {
        dispatch_async(dispatch_get_main_queue(), ^{
            [self.delegate uploadIntroRecordViewDidOutputSampleBuffer:sampleBuffer isVideo:captureOutput == self.videoOutput];
        });
    }
