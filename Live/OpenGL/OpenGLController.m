...
@interface OpenGLController ()<HDUploadIntroRecordViewDelegate>
...
#pragma mark - HDUploadIntroRecordViewDelegate
/// 开始录制
...
/// 使用OpenGl显示
- (void)uploadIntroRecordViewDidOutputSampleBuffer:(CMSampleBufferRef)sampleBuffer isVideo:(BOOL)isVideo {
